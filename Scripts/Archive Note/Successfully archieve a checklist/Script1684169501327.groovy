...
Mobile.setText(findTestObject('ColorNote/android.widget.EditText (3)'), 'Item B', 0)
...
Mobile.verifyElementExist(findTestObject('ColorNote/android.widget.TextView - Checklist Title'), 0)
