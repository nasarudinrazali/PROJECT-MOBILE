...
Mobile.setText(findTestObject('ColorNote/android.widget.EditText - Search'), title, 0)

actualTitle = Mobile.getText(findTestObject('ColorNote/android.widget.TextView - Checklist Title (1)', [('titleParam') : title]), 
